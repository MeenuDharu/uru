...
@Component({
	selector: 'app-takeaway-order',
	templateUrl: './takeaway-order.component.html',
	styleUrls: ['./takeaway-order.component.css']
})
export class TakeawayOrderComponent implements OnInit {
